...
public class BookCommentServiceTest {
    ...
    public void createTest() {
        ...
        Book book = new Book();
        book.setId("1");
        BookComment expected = new BookComment("1", bookCommentDto.getMessage(), book);
        ...
        BookComment actual = bookCommentService.create(book.getId(), bookCommentDto.getMessage());
